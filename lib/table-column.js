    ...
    setColumnRenders: function setColumnRenders(column) {
      ...
      if (this.renderHeader) {
        ...
        column.renderHeader = function (h, scope) {
          ...
          return renderHeader ? renderHeader(scope) : h(
            'span',
            { 'class': 'label' },
            [column.label]
          );
        };
        column.renderOtherHeader = function (h, scope) {
          var renderOtherHeader = _this2.$scopedSlots.otherHeader;
          return renderOtherHeader ? renderOtherHeader(scope) : '';
        };
      }
